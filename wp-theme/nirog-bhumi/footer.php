<footer class="nb-footer">
  ...
  <div class="footer-links">
    ...
    <div><h3>Support</h3><a href="<?php echo esc_url(home_url('/faqs/')); ?>">FAQs</a><a href="<?php echo esc_url(home_url('/terms-and-conditions/')); ?>">Terms &amp; Conditions</a><a href="<?php echo esc_url(home_url('/privacy-policy/')); ?>">Privacy Policy</a><a href="<?php echo esc_url(home_url('/cancellation-refund-policy/')); ?>">Cancellation &amp; Refund</a><a href="<?php echo esc_url(home_url('/shipping-delivery-policy/')); ?>">Shipping &amp; Delivery</a><a href="<?php echo esc_url(home_url('/return-policy/')); ?>">Return Policy</a><a href="<?php echo esc_url(home_url('/medical-disclaimer/')); ?>">Medical Disclaimer</a><a href="<?php echo esc_url(home_url('/policies/')); ?>">All Policies</a></div>
  </div>
