...
<header class="nb-header">
  ...
  <nav id="primary-navigation" data-menu><div class="nav-dropdown" data-nav-dropdown><button class="nav-dropdown-toggle" type="button" aria-expanded="false" aria-haspopup="true" data-nav-dropdown-toggle>About</button><div class="nav-dropdown-menu"><a href="<?php echo esc_url(home_url('/about/')); ?>">About Us</a><a href="<?php echo esc_url(home_url('/founder-story/')); ?>">Founder's Story</a></div></div><a href="<?php echo esc_url(home_url('/programmes/')); ?>">Our Programs</a><?php if (function_exists('nirog_bhumi_store_catalogue_is_visible') && nirog_bhumi_store_catalogue_is_visible()) : ?><a href="<?php echo esc_url(home_url('/store/')); ?>">Store</a><?php endif; ?><a href="<?php echo esc_url(home_url('/faqs/')); ?>">FAQs</a><a href="<?php echo esc_url(home_url('/education/')); ?>">Education</a><a href="https://expedition.nirogbhumi.com" target="_blank" rel="noopener">Expedition</a><?php do_action('nirog_bhumi_header_end'); ?></nav>
</header>
