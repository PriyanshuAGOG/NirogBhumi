...
<section class="svg-flow-section" data-flow-root>
  ...
  <g class="node c-pink" data-flow-node tabindex="0" role="button"><rect x="518" y="378" width="155" height="64" rx="8" stroke-width="0.5"/><text class="th" x="595" y="396" text-anchor="middle" dominant-baseline="central">Ultra-processed Foods</text></g>
  ...
  <path d="M340 864 L150 872 L150 880" fill="none" stroke="#0F6E56" stroke-width="1.5" marker-end="url(#arr)"/>
  <line x1="340" y1="864" x2="340" y2="880" stroke="#0F6E56" stroke-width="1.5" marker-end="url(#arr)"/>
  <path d="M340 864 L530 872 L530 880" fill="none" stroke="#0F6E56" stroke-width="1.5" marker-end="url(#arr)"/>
  ...
  <text class="ts" x="340" y="1280" text-anchor="middle" font-style="italic">The 6-month program combines all six tools simultaneously.</text>
