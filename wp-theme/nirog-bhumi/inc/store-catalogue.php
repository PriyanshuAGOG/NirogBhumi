...
function nirog_bhumi_store_catalogue() {
  return [
    [
      ...
      'ritual' => [
        __('Prepare safe water - use clean water which is boiled and cooled to lukewarm temperature.', 'nirog-bhumi'),
        __('Prepare saline water - add roughly 1/2 a teaspoon of clean salt fully dissolved in half a litre of water.', 'nirog-bhumi'),
        __('Stand over a sink, lean slightly forward, tilt the head to one side, and breathe through the mouth.', 'nirog-bhumi'),
        __('Fill the Pot and rest the spout gently in the upper nostril to form a comfortable seal.', 'nirog-bhumi'),
        __('Tilt the Pot so that the water flows in through the upper nostril and out through the lower one, for about 20 to 30 seconds.', 'nirog-bhumi'),
        __('Remove the Pot, let residual water drain out, and repeat on the other side.', 'nirog-bhumi'),
        __('Dry the nasal passages with gentle exhalations - avoid forceful nose-blowing.', 'nirog-bhumi'),
        __('Perform Kapal Bhati and Atrika Pranayam after doing Jala Neti. (Please exercise all precautions generally recommended for these two practices.)', 'nirog-bhumi'),
      ],
      'benefits' => [
